...
_st_.blockend()
try:
 _st_.current_tex_line = 1181
 _st_.inline(0, latex(N(P/1e-6)))
except:
 _st_.goboom(1181)
_st_.current_tex_line = 1319
_st_.blockbegin()
try:
 import pandas as pd
...
_st_.blockend()
try:
 _st_.current_tex_line = 1368
 _st_.plot(10, format='notprovided', _p_=E, figsize=(8,10))
except:
 _st_.goboom(1368)
_st_.current_tex_line = 1470
_st_.blockbegin()
try:
 alpha = 2*3.1415

...
\end{eqnarray}
O calculo para os elementos da diagonal principal da matriz densidade são obtidos pela equação \eqref{eq:4.45}. Assim, $\dot{\rho}_{11}$ é dado por 
\begin{eqnarray}
...
\input{figuras_do_trabalho/p22.tex}

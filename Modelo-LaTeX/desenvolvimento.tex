...
Nesta seção apresentamos o algoritmo utilizado para resolver as equações de Maxwell-Bloch, antes temos  Esses resultados foram calculados usando algoritmo de Runge-Kutta escrito  em linguagem C apresentado no apêndice B, seguindo o fluxograma mostrado na figura 2.

...
\label{eq:4.26}
\end{equation}
Substituindo estes resultados na equação do hamiltoniano $\hat{H}'$ \eqref{eq:4.22}, obtemos
\begin{equation}
...
\label{eq:4.28}
\end{equation}
Essa equação representa a energia de um dipolo elétrico inserido num campo elétrico $E$. Para isso, consideramos que um único elétron é o responsável pelo surgimento pelo momento de dipolo elétrico[].
...
\begin{eqnarray}
\omega_{21} & = & \omega_2 - \omega_1\label{eq:4.29}\\
& = & (E_2-E_1)/\hbar \label{eq:4.30}.
\end{eqnarray}
\begin{figure}[H]
	\centering 
...
\label{eq:4.32}
\end{equation}
sendo $\hbar \omega_{1}$ e $\hbar \omega_{2}$ são os valores de energia para os estado $\ket{1}$ e $\ket{2}$, respectivamente. Assim, o hamiltoniano do átomo interagindo com o campo é
\begin{equation}
\hat{H} = \hbar \omega _1\dyad{1}{1} +\hbar \omega _2\dyad{2}{2} - \hat{d}\vb{E} 
\label{eq:4.33}
\end{equation}


No capitulo \ref{cap:capitulo2} nos obtemos a equação de J. von - Newman, que descreve a evolução temporal da matriz densidade. 
